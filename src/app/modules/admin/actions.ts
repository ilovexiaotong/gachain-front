...
export const changePage = actionCreator<{ text?: string, class?: string; align?: string; transform?: string; wrap?: string, color?: string; btn?: string; width?: string; ratio?: string; canDropPosition?: string; tagID: string, pageID: string, vde?: boolean }>('CHANGE_PAGE');
