...
import { ITableResponse, IDataResponse, IHistoryResponse, IPageResponse, IMenuResponse, IBlockResponse, IParamResponse, IContractsResponse, ITablesResponse } from 'gachain/api';
