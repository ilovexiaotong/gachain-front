    ...
    render() {
        return (
            <Wrapper
                ...
                description={
                    <FormattedMessage id="admin.export.description" defaultMessage="Select every element which do you want to export and proceed to the payload generation process. Make sure that you select all of the dependencies that your application requires to function properly" />
                }
            >
                <Row>
                    <Col md={8} lg={9}>
