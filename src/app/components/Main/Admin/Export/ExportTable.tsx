...
export interface IExportTableProps {
    payload: {
        [key: string]: any;
    }[];
    dataKey: string;
...
interface IExportTableState {
    selected: Set<string>;
}

class ExportTable extends React.Component<IExportTableProps, IExportTableState> {
    constructor(props: IExportTableProps) {
        super(props);
        this.state = {
            selected: Set()
        };
